...
//double a[4] = {0.0,M_PI_2 , 0.075, 0.0};
//double alpha[4] = {0.130230565, 0.0, 0.0, M_PI_2 + atan(0.024/0.128)};
//double d[4] = {0.124, 0.0, 0.0, atan(0.128/0.024)};
//double theta[4] = {0.07, 0.0, 0.0, 0.0};

double a[4] = {0.0, 0.130230565 , 0.124, 0.07};
