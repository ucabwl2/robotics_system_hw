...
class iiwa14KDL(object):
    def __init__(self):
        ...
        ##Change these names according to your robot. Please refer to the urdf file.
        base_link = "base_link"
        ee_link = "arm_link_5"
    ...
    def inverse_kinematics_closed(self, desired_pose):
        #This "desired_pose" is PyKDL.Frame. The output is a PyKDL.JntArray. 
